...
Junior consulting or mid-level backend software engineering position at Red Hat.
\blankline
...
\begin{loneinnerlist}
    ...
    \item Extensive experience with running \href{http://www.ubuntu.com/server}{Ubuntu} on servers, and some familiarity with \href{http://www.debian.org/}{Debian} and \href{http://www.redhat.com/en/technologies/linux-platforms/enterprise-linux}{RHEL}.
