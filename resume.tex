...
Mid-level backend software engineering position at Palantir.
\blankline
...
\item[] \href{https://www.nebula.com}{\textbf{Nebula, Inc.}}, Seattle, WA and Mountain View, CA \hfill{\textbf{June 2012 - April 2015}}
    ...
    \item Architected and implemented a pipelined secure log collection tool.
...
\item[] \href{http://www.kellycreativetech.com/}{\textbf{Kelly Creative Tech, Inc.}}, Columbus, OH \hfill{\textbf{June 2011 - September 2011}}
    \begin{innerlist}
    \item[] \textbf{Intern}
    \item Maintained Django-based websites and wrote data importers and exporters.
    \end{innerlist}
\end{outerlist}
